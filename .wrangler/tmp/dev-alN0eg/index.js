...
function normalizeInvoiceIds(raw2) {
  if (raw2 === void 0 || raw2 === null) return null;
  if (Array.isArray(raw2)) {
    const ids = raw2.map((val) => String(val).trim()).filter(Boolean);
  ...
  const str = String(raw2).trim();
  return str ? str : null;
}
__name(normalizeInvoiceIds, "normalizeInvoiceIds");
...
// .wrangler/tmp/bundle-v89bir/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-v89bir/middleware-loader.entry.ts
